(function () {
  var EL = {
    intro: [
      ...
      "Κατανοούμε τις ανησυχίες σας σχετικά με την ιδιωτικότητα των πληροφοριών που μας κοινοποιείτε. Όταν μας παρέχετε προσωπικά δεδομένα, συναινείτε στη χρήση και, όπου απαιτείται, στην κοινοποίησή τους για σκοπούς που σχετίζονται με την εγγραφή σας σε ενημερώσεις, τη διαχείριση παραγγελιών ή την επικοινωνία μαζί σας.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "• μας έχετε δώσει ρητή συγκατάθεση,",
          "• απαιτείται για την παροχή υπηρεσίας (π.χ. courier για παράδοση),",
          ...
          "Δεδομένα παραγγελίας διατηρούνται για 2 έτη από την παράδοση· σε περίπτωση διαφοράς μπορεί να παραταθεί η διατήρηση.",
        ],
      },
      {
        id: "cookies",
  ...
  var EN = {
    intro: [
      ...
      "We understand your concerns about the privacy of the personal information you share with us. When you provide personal data, you consent to our using and, where relevant, disclosing it for purposes related to managing your orders and communicating with you.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "• sharing is required to provide a service (e.g. courier for delivery),",
          ...
          "Order data is retained for 2 years from delivery; retention may be extended in the event of a dispute.",
        ],
      },
      {
        id: "cookies",
