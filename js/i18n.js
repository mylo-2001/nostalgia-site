(function () {
  ...
  var STRINGS = {
    el: {
      ...
      payments_trust1_text: "Για παραγγελίες άνω των 100€.",
      ...
      shipping_section2_p2: "Για επιλέξιμες παραγγελίες άνω των 100€ εντός ΕΕ, η αποστολή μπορεί να είναι δωρεάν ανάλογα με τη μέθοδο.",
    ...
    en: {
      ...
      payments_trust1_text: "For all orders over 100€.",
      ...
      shipping_section2_p2: "For eligible orders above 100€ within the EU, delivery may be free depending on the selected method.",
