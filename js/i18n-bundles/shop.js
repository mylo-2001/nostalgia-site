(function () {
  ...
  window.NostalgiaI18nRegister({
    el: {
      ...
      checkout_gift_is_gift_desc: "Ενεργοποιεί τις επιλογές συσκευασίας και αποστολής δώρου.",
    ...
    en: {
      ...
      checkout_gift_is_gift_desc: "Enables gift wrapping and delivery options.",
