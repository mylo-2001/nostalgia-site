(function () {
  ...
  var STRINGS = {
    el: {
      ...
      about_soul_dialogue_q: "«Μαρία Νοσταλγία μου», χαριτολογώντας: «Δεν κοιμήθηκες;»",
    ...
    en: {
      ...
      about_soul_dialogue_q: "“My nostalgic Maria,” teasing: “Did you not sleep?”",
  ...
  function applyLang(lang, opts) {
    ...
    var metaKey =
      document.body &&
      document.body.getAttribute("data-page") === "about"
        ? "meta_title_about"
        : document.body &&
          document.body.getAttribute("data-page") === "collection"
        ? "meta_title_collection"
        : document.body &&
          document.body.getAttribute("data-page") === "contact"
        ? "meta_title_contact"
        : "meta_title_home";
