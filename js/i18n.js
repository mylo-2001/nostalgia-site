(function () {
  ...
  var STRINGS = {
    el: {
      ...
      collection_cat4: "Vintage Unique Objects",
      ...
      collection_lead_cat5:
        "NI TERRA · ANCIENT NOSTALGIA",
      collection_lead_cat6:
        "Coming soon · Discover fragrances inspired by cherished moments, warm summers and timeless nostalgia.",
      collection_lead_cat7:
        "Coming soon · A collection of refined home fragrances designed to transform everyday spaces into cherished memories.",
      collection_lead_cat8:
        "Our exclusive NI NOSTALGIA gift collection is coming soon. Stay tuned for a thoughtfully curated gifting experience.",
      ...
      contact_form_attachment_hint: "Σημείωση: η επισύναψη δεν αποστέλλεται αυτόματα μέσω mail app. Επισυνάψτε το αρχείο χειροκίνητα στο email που ανοίγει.",
      ...
      payments_trust1_text: "Για παραγγελίες από 80€ και άνω.",
      ...
      shipping_section2_p2: "Για παραγγελίες από 80€ και άνω, τα μεταφορικά είναι δωρεάν.",
    ...
    en: {
      ...
      contact_form_attachment_hint: "Note: attachments are not sent automatically through your mail app. Please attach the file manually in the opened email.",
      ...
      payments_trust1_text: "For orders from €80 and above.",
      ...
      shipping_section2_p2: "For orders from €80 and above, shipping is free.",
